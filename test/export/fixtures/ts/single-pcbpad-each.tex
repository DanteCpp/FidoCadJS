...
\filldraw[color=layer0] (8,8) ellipse [x radius=5, y radius=5];
\filldraw[color=layer0] (33,3) rectangle ++(10,10);
\filldraw[color=layer0] (63,3) rectangle ++(10,10);
\filldraw[color=white] (8,8) ellipse [x radius=1.5, y radius=1.5];
\filldraw[color=white] (38,8) ellipse [x radius=1.5, y radius=1.5];
\filldraw[color=white] (68,8) ellipse [x radius=1.5, y radius=1.5];
\end{tikzpicture}